...
G.PRISM.djinn_banned_rarities = {4,"cry_exotic","pridark_prismatic","entr_entropic","entr_zenith";"entr_reverse_legendary","tje_tjHl","rsgc_prim","rsgc_unb","rsgc_gast_err"}
...
--For Entropy Compatibility
if Entropy then
	Entropy.DefineBlacklist.c_prism_spectral_djinn = true
end
